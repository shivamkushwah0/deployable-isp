            ...
            <div className="p-5 si_div">
                ...
                <div className="col-sm-6 text-center">
                            ...
                            <div className="col-sm-6 text-center">
                                ...
                                <TextField onBlur={()=>{setBlurScore({...blurScore , gstScore:true })}} className="textfield" name="gts"  value={inputField.gts} variant="filled" onChange={event=>props.handleChangeInput(index,event)}></TextField>
                                <br />
                                {
                        ...
                        <div className="row mt-5">
                            ...
                            <div className="col-sm-6 text-center">
                                ...
                                <TextField onBlur={()=>{setBlurScore({...blurScore , stsScore:true })}} className="textfield" name="sts" value={inputField.sts} variant="filled" onChange={event=>props.handleChangeInput(index,event)}></TextField>
                                <br />
                                {
